...
class TurbopropAero(System):
    ...
    def setup(self):
        # inwards
        self.add_inward(
            "primary_nozzle_thrust", 1000.0, unit="N", desc="total thrust generated by primary nozzle"
        )
        self.add_inward(
            "propeller_thrust", 1000.0, unit="N", desc="total thrust generated by propeller"
        )
